...
Experiment Name: C1_pconv_p23
Date: Pending

Baseline: Official YOLO11n

Modification: Replace only Bottleneck.cv2 inside the P2/P3 backbone C3k2 blocks with Pinwheel-shaped PConv. Preserve Bottleneck.cv1 and every other layer.

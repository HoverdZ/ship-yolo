...
Experiment Name: C2_lskconv_p23
Date: Pending

Baseline: Official YOLO11n

Modification: Replace only Bottleneck.cv2 inside the P2/P3 backbone C3k2 blocks with the Large Selective Kernel convolution core. Preserve Bottleneck.cv1 and every other layer.
